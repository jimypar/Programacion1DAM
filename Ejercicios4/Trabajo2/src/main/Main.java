...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * Mostrar el promedio de grupos que están en un mismo año escolar; siendo que
		 * cada grupo puede tener n alumnos que cada alumno puede llevar m materias y
		 * que en todas las materias se promedian tres calificaciones para obtener el
